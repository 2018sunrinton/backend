module.exports = (router, request)=>{
  router.post('/',async(req,res)=>{
    var apiurl = "https://maps.googleapis.com/maps/api/place/nearbysearch/json?region=kr&location=" + req.body.x.replace(/'/gi,'') + "," + req.body.y.replace(/'/gi,'') + "&radius=3000&type=subway_station&key=AIzaSyC0WvUEVSxSbcLhUw_ndmcLhf2_HkuDs5c";
